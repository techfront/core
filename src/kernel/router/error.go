...
// MethodNotAllowed returns a new StatusError with Status StatusMethodNotAllowed and optional Title and Message
// Usage return router.MethodNotAllowed(err,"Optional Title", "Optional user-friendly Message")
func MethodNotAllowedError(e error, args ...string) *StatusError {
	err := Error(e, http.StatusMethodNotAllowed, "Not Allowed", "Sorry, I can't let you do that.")
	return err.setupFromArgs(args...)
}
