...
func generateConfig(projectPath string) error {
	...
	ConfigTest = map[string]string{
		...
		"mail_port":         "587",
		"mail_from":         "a.shelepenok@gmail.com",
		"mail_username":     "ASHK.IO",
		"mail_secret":       "3gxZbBirROOZFj9_mhFLqA",

		"cache_store":              "./tmp/cache",
		"cache_default_expiration": "720",
		"cache_cleanup_interval":   "30",

		"limiter_store":      "./tmp/limiter",
		"limiter_login_rate": "10",
	}
	...
	ConfigDevelopment["embedly_key"] = ""
	ConfigDevelopment["mailchimp_key"] = ""
	ConfigDevelopment["mailchimp_list_id"] = ""
	ConfigDevelopment["uploads_dir"] = "public/uploads"
	ConfigDevelopment["mail_server"] = ""
	ConfigDevelopment["mail_port"] = ""
	ConfigDevelopment["mail_from"] = ""
	ConfigDevelopment["mail_username"] = ""
	ConfigDevelopment["mail_secret"] = ""

	ConfigDevelopment["cache_store"] = "./tmp/cache"
	ConfigDevelopment["cache_default_expiration"] = "720"
	ConfigDevelopment["cache_cleanup_interval"] = "30"

	ConfigDevelopment["limiter_store"] = "./tmp/limiter"
	ConfigDevelopment["limiter_login_rate"] = "10"
	...
	ConfigProduction["embedly_key"] = ""
	ConfigProduction["mailchimp_key"] = ""
	ConfigProduction["mailchimp_list_id"] = ""
	ConfigProduction["uploads_dir"] = "public/uploads"
	ConfigProduction["mail_server"] = ""
	ConfigProduction["mail_port"] = ""
	ConfigProduction["mail_username"] = ""
	ConfigProduction["mail_from"] = ""
	ConfigProduction["mail_secret"] = ""

	ConfigProduction["cache_store"] = "./tmp/cache"
	ConfigProduction["cache_default_expiration"] = "720"
	ConfigProduction["cache_cleanup_interval"] = "30"

	ConfigProduction["limiter_store"] = "./tmp/limiter"
	ConfigProduction["limiter_login_rate"] = "10"
